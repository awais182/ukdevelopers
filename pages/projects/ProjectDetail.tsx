              ...
              <section className="space-y-6 bg-gradient-to-b from-white to-gold/5 p-5 sm:p-6 md:p-8 lg:p-10 rounded-3xl border border-gold/20 shadow-xl">
                <div className="flex flex-col gap-3">
                  <div>
                    ...
                    <h3 className="text-black font-black uppercase tracking-tight leading-tight text-[clamp(1.4rem,2.8vw,2rem)] max-w-3xl">Key metrics that matter</h3>
                  </div>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 md:gap-5">
                  {project.units && (
                    <article className="h-full flex flex-col justify-between border border-gold/30 rounded-2xl p-2 sm:p-3 bg-white shadow-lg transition-all hover:shadow-2xl">
                      <div>
                        <h4 className="text-gray-400 uppercase tracking-[0.35em] text-[0.6rem]">Total Units</h4>
                        <p className="mt-2 text-[clamp(1.4rem,2.2vw,1.8rem)] font-black text-black leading-none">{project.units}</p>
                      </div>
                  ...
                  {project.floors && (
                    <article className="h-full flex flex-col justify-between border border-gold/30 rounded-2xl p-2 sm:p-3 bg-white shadow-lg transition-all hover:shadow-2xl">
                      <div>
                        <h4 className="text-gray-400 uppercase tracking-[0.35em] text-[0.6rem]">Floors</h4>
                        <p className="mt-2 text-[clamp(1.4rem,2.2vw,1.8rem)] font-black text-black leading-none">{project.floors}</p>
                      </div>
                  ...
                  <article className="h-full flex flex-col justify-between border border-gold/30 rounded-2xl p-2 sm:p-3 bg-white shadow-lg transition-all hover:shadow-2xl">
                    <div>
                      <h4 className="text-gray-400 uppercase tracking-[0.35em] text-[0.6rem]">Category</h4>
                      <p className="mt-2 text-[clamp(1.2rem,1.8vw,1.6rem)] font-black text-black uppercase leading-tight break-words">{project.category}</p>
                    </div>
                  ...
                  <article className="h-full flex flex-col justify-between border border-gold/30 rounded-2xl p-2 sm:p-3 bg-white shadow-lg transition-all hover:shadow-2xl">
                    <div>
                      <h4 className="text-gray-400 uppercase tracking-[0.35em] text-[0.6rem]">Status</h4>
                      <p className={`mt-2 text-[clamp(1.2rem,1.8vw,1.6rem)] font-black uppercase leading-tight break-words ${
