        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="mt-12 sm:mt-16 pt-12 sm:pt-16 border-t border-gray-200">
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
              ...
              <a href={COMPANY_INFO.social.tiktok} target="_blank" rel="noopener noreferrer" className="text-gold hover:text-white hover:bg-gold p-3 sm:p-3.5 border border-gold rounded transition-all" title="TikTok">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
